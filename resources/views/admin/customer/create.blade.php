            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Tambah Customer</li>
                </ul>
              </div>
              <div class="col-md-12">
                ...
                <form action="{{ route('customer.store') }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <div class="form-floating ">
                                        <input value="{{  old('phone') }}" type="number" class="form-control" id="floatingEmail" placeholder="Contoh: 083333XXXX" name="phone">
